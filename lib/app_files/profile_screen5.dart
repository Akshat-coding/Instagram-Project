...
class ProfileScreen5 extends StatefulWidget {
  const ProfileScreen5({super.key});

  @override
  State<ProfileScreen5> createState() => _ProfileScreen5State();
}

class _ProfileScreen5State extends State<ProfileScreen5> {
  @override
                  ...
                  Row(
                    children: [
                      Padding(
                        ...
                        child: Text("business@chefnick.com",
                          style: TextStyle(fontSize: 18),
                        ),
                      ),
                    ],
